...
CREATE TABLE [dbo].[Fato_001] (
    ...
    PRIMARY KEY CLUSTERED ([Cod_Produto] ASC, [Cod_Cliente] ASC, [Cod_Organizacional] ASC, [Cod_Fabrica] ASC, [Cod_Dia] ASC)
);
...
CREATE TABLE [dbo].[Fato_002] (
    ...
    [Cod_Dia]     NVARCHAR (50) NOT NULL,
    [Frete]       FLOAT (53)    NULL,
    PRIMARY KEY CLUSTERED ([Cod_Produto] ASC, [Cod_Cliente] ASC, [Cod_Fabrica] ASC, [Cod_Dia] ASC)
);
...
CREATE TABLE [dbo].[Fato_004] (
    ...
    PRIMARY KEY CLUSTERED ([Cod_Produto] ASC, [Cod_Cliente] ASC, [Cod_Organizacional] ASC, [Cod_Dia] ASC)
);
...
END
GO
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = '12d70c61-d2f5-4801-9d3f-823d393d9e1d')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('12d70c61-d2f5-4801-9d3f-823d393d9e1d')
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = 'f3889e47-4ce0-497c-825c-9686ec4e2395')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('f3889e47-4ce0-497c-825c-9686ec4e2395')
...
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = '9175cee3-c1e6-4f83-803c-3d09cf6df262')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('9175cee3-c1e6-4f83-803c-3d09cf6df262')
...
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = 'fae3856e-9c65-4879-a756-16c42aa988a5')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('fae3856e-9c65-4879-a756-16c42aa988a5')
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = 'b66e7316-c103-4fe4-afd0-8ec1372274fe')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('b66e7316-c103-4fe4-afd0-8ec1372274fe')
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = '8e473cc1-63e9-4269-a1cb-78339839a927')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('8e473cc1-63e9-4269-a1cb-78339839a927')
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = '4a242a63-356a-4b60-a57d-135b543ef566')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('4a242a63-356a-4b60-a57d-135b543ef566')
