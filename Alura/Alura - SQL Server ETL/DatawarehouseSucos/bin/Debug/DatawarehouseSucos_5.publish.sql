...
GO
PRINT N'Rename refactoring operation with key fae3856e-9c65-4879-a756-16c42aa988a5 is skipped, element [dbo].[Fato_001].[Id] (SqlSimpleColumn) will not be renamed to Cod_Cliente';


GO
PRINT N'Rename refactoring operation with key b66e7316-c103-4fe4-afd0-8ec1372274fe is skipped, element [dbo].[Fato_001].[Cod_dia] (SqlSimpleColumn) will not be renamed to Cod_Dia';


GO
PRINT N'Rename refactoring operation with key 8e473cc1-63e9-4269-a1cb-78339839a927 is skipped, element [dbo].[Fato_001].[Quantidade] (SqlSimpleColumn) will not be renamed to Quantidade_Vendida';


GO
PRINT N'Rename refactoring operation with key 6b80f020-640b-46c1-a4df-d6db96dd8081 is skipped, element [dbo].[Fato003].[Frete] (SqlSimpleColumn) will not be renamed to Custo_Fixo';
...
GO
PRINT N'Creating Table [dbo].[Fato003]...';
...
GO
PRINT N'Creating Table [dbo].[Fato004]...';
...
GO
PRINT N'Creating Table [dbo].[Fato005]...';
...
GO
ALTER TABLE [dbo].[Fato004] WITH NOCHECK
...
GO
ALTER TABLE [dbo].[Fato005] WITH NOCHECK
...
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = '6b80f020-640b-46c1-a4df-d6db96dd8081')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('6b80f020-640b-46c1-a4df-d6db96dd8081')
...
ALTER TABLE [dbo].[Fato003] WITH CHECK CHECK CONSTRAINT [FK_Fato_003_Dim_Fabrica];

ALTER TABLE [dbo].[Fato003] WITH CHECK CHECK CONSTRAINT [FK_Fato_003_Dim_Tempo];

ALTER TABLE [dbo].[Fato004] WITH CHECK CHECK CONSTRAINT [FK_Fato_004_Dim_Cliente];

ALTER TABLE [dbo].[Fato004] WITH CHECK CHECK CONSTRAINT [FK_Fato_004_Dim_Produto];

ALTER TABLE [dbo].[Fato004] WITH CHECK CHECK CONSTRAINT [FK_Fato_004_Dim_Organizacional];

ALTER TABLE [dbo].[Fato004] WITH CHECK CHECK CONSTRAINT [FK_Fato_004_Dim_Tempo];

ALTER TABLE [dbo].[Fato005] WITH CHECK CHECK CONSTRAINT [FK_Fato_005_Dim_Produto];

ALTER TABLE [dbo].[Fato005] WITH CHECK CHECK CONSTRAINT [FK_Fato_005_Dim_Fabrica];

ALTER TABLE [dbo].[Fato005] WITH CHECK CHECK CONSTRAINT [FK_Fato_005_Dim_Tempo];
