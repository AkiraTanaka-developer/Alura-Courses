...
GO
/*
The column [dbo].[Fato003].[Custo_Fixo] is being dropped, data loss could occur.
*/

IF EXISTS (select top 1 1 from [dbo].[Fato003])
    RAISERROR (N'Rows were detected. The schema update is terminating because data loss might occur.', 16, 127) WITH NOWAIT

GO
PRINT N'Altering Table [dbo].[Fato003]...';


GO
ALTER TABLE [dbo].[Fato003] DROP COLUMN [Custo_Fixo];


GO
ALTER TABLE [dbo].[Fato003]
    ADD [Frete] FLOAT (53) NULL;
